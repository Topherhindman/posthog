...
import { fingerprintIssueStateCacheLogic } from '../../logics/fingerprintIssueStateCacheLogic'
...
export const errorTrackingSceneLogic = kea<errorTrackingSceneLogicType>([
    ...
    connect(() => ({
        values: [
            ...
            ['selectedSettingId'],
            fingerprintIssueStateCacheLogic,
            ['currentOverrides'],
        ],
        actions: [
            issueActionsLogic,
        ...
        query: [
            ...
            (
                ...
                return errorTrackingQuery({
                    ...
                    orderDirection,
                    useQueryV3: v3Active,
                    fingerprintIssueStateOverrides: v3Active ? currentOverrides : undefined,
                })
            },
        ],
        breadcrumbs: [

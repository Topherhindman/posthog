...
export const projectionEditorLogic = kea<projectionEditorLogicType>([
    ...
    selectors({
        ...
        sourceLoading: [
            () => [
                (state: any, props: ProjectionEditorLogicProps) =>
                    dataWarehouseSourceSettingsLogic({ id: props.id, tabId: props.tabId }).selectors.sourceLoading(
                        state
                    ),
            ],
    ...
    listeners(({ actions, values, props }) => ({
        loadSource: async () => {
            dataWarehouseSourceSettingsLogic({ id: props.id, tabId: props.tabId }).actions.loadSource()
        },
